...
public class Jogar extends javax.swing.JFrame {
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(Ct1, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(jLabel5)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(Ct2, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGap(118, 118, 118)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        t1 = tDAO.buscarTime(Ct1.getText());
        
        IntegranteDAO iDAO = new IntegranteDAO();
        ArrayList<Integrante> listaDeIntegrantes = new ArrayList<>();
        listaDeIntegrantes = iDAO.buscarIntegrante(Ct1.getText());
        for (int i = 0; i < listaDeIntegrantes.size(); i++) {
            pontuacaoTime1 += listaDeIntegrantes.get(i).pontuacao;
        }
        
        t2 = tDAO.buscarTime(Ct2.getText());
        ArrayList<Integrante> listaDeIntegrantes2 = new ArrayList<>();
        listaDeIntegrantes2 = iDAO.buscarIntegrante(Ct2.getText());
        for (int i = 0; i < listaDeIntegrantes2.size(); i++) {
            pontuacaoTime2 += listaDeIntegrantes2.get(i).pontuacao;
        }
        ...
        int chance;
        chance = (pontuacaoTime1*100)/(pontuacaoTime1+pontuacaoTime2);
        
        if (result < chance) {
            JOptionPane.showMessageDialog(this,t1.nomeTime + " VENCEU!!");
        }
        if (result >= chance) {
            JOptionPane.showMessageDialog(this,t2.nomeTime + " VENCEU!!");
        }
